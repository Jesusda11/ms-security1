...
import com.jda.ms_security.Models.*;
...
public class ValidatorsService {
    ...
    private static final String BEARER_PREFIX = "Bearer "; //   Diferentes tipos de autenticacion.
    ...
    public User getUser(final HttpServletRequest request) {
        User theUser=null;
        String authorizationHeader = request.getHeader("Authorization"); //Tomo eso del POSTMAN
